...
void scanFill(int,int,int,int);//scanline boundary filling aglo
void midLine(int,int,int,int);// midpoint algo for line
...
int main()
{
  ...
  int bc=3;
    ...
    scanFill(320+x,320-y,fc,bc);//320+x, 320-y => adjusted for cartesian algo
