...
void boundaryFill_4(int,int,int,int);
...
int main()
{
  ...
  int bc=3;
    ...
    boundaryFill_4(320+x,320-y,fc,bc);
...
void boundaryFill_4(int x, int y,int fc, int bc)
{
    ...
    {
        putpixel(x,y,fc);
        boundaryFill_4(x+1,y,fc,bc);
        boundaryFill_4(x-1,y,fc,bc);
        boundaryFill_4(x,y+1,fc,bc);
        boundaryFill_4(x,y-1,fc,bc);
    }
}
